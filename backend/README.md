...
## Project Structure
    ...
    ├── testapiautoteammemb_53646  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_53646`
...
2. Clone this repo and `cd testapiautoteammemb_53646`
